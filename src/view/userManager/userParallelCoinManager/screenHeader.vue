...
// 类型
import type { UserParallelCoinListScreenParams } from "@/type/User";
...
const emit = defineEmits<{
  (event: "submitSearch", params: UserParallelCoinListScreenParams): void;
}>();

const params = reactive<UserParallelCoinListScreenParams>({});
