<template>
  <n-space>
    <n-input v-model:value="params.chainAddress" autosize placeholder="请输入地址" style="width: 200px" :disabled="searching"></n-input>
    <n-input v-model:value="params.goodsId" autosize placeholder="请输入商品编号" style="width: 200px" :disabled="searching"></n-input>
    <n-input v-model:value="params.token" autosize placeholder="请输入token" style="width: 200px" :disabled="searching"></n-input>
    <n-input v-model:value="params.uid" autosize placeholder="请输入用户uid" style="width: 200px" :disabled="searching"></n-input>

    <n-select :options="transferStateList" v-model:value="params.transState" placeholder="请选择状态" clearable :disabled="searching" style="width: 200px"></n-select>
